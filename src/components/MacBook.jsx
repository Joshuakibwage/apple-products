...
const MacBook = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-around bg-white p-8 ">
        ...
        <div className="flex">
            {
                macBookModels.map((mb, index) => (
                    <button 
                    key={index}
                    className={`2xl:w-40 md:w-26 w-28 2xl:h-21 md:h-12 h-12 flex flex-col justify-evenly 
